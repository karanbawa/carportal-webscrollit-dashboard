...
//import action
import { getOrderTotalAveragePrice, getRevenueTotalData, getTotalOrderCount, getChartsData as onGetChartsData } from "../../store/actions";
...
const Dashboard = props => {
  ...
  const { chartsData, ordersCount, totalRevenue, orderDataAveragePrice } = useSelector(state => ({
  ...
  useEffect(() => {
    setReportsData((prevData) => {
      prevData[0].description = ordersCount;
      return prevData;
    });
  }, [ordersCount])
    ...
    <React.Fragment>
      <div className="page-content">
        <Container fluid>
          ...
          <Row>
            <Col xl="4">
              <WelcomeComp totalRevenue = {reports[1].description} totalSales = {reports[0].description} author={authorName} />
              <MonthlyEarning />
            </Col>
            <Col xl="8">
              <Row>
